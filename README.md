...
When a player places a card that completes a row-colum combination, that player may place a dot marker on the cell in the 3 by 3 grid that corresponds to the intersection of the row-column combination that they just completed. 
